...
""")
    ...
    def _print_stats(self) -> None:
        ...
        print(Fore.WHITE + Style.BRIGHT + self.title)
        print(Fore.RESET + Style.RESET_ALL)
        print(Style.BRIGHT + f"                           [ COMPRAS HECHAS: {Fore.MAGENTA}{Style.BRIGHT}{self.buys}{Fore.GREEN}{Style.BRIGHT} ]")
        print(Style.BRIGHT + f"                           [ ERRORES: {Fore.WHITE}{Style.BRIGHT}{self.errors}{Fore.RED}{Style.BRIGHT} ]")
        print(Style.BRIGHT + f"                           [ VELOCIDAD: {Fore.MAGENTA}{Style.BRIGHT}{self.last_time}{Fore.BLUE}{Style.BRIGHT} ]")
        print(Style.BRIGHT + f"                           [ LIMITEDS COMPRADOS: {Fore.WHITE}{Style.BRIGHT}{self.total_ratelimits}{Fore.GREEN}{Style.BRIGHT} ]")
        print(Style.BRIGHT + f"                           [ TOTAL PRECIOS ACTUALIZADOS: {Fore.MAGENTA}{Style.BRIGHT}{self.checks}{Fore.YELLOW}{Style.BRIGHT} ]")
        print()
        print(Style.BRIGHT + f"                           [ TAREAS: {Fore.WHITE}{Style.BRIGHT}{self.task}{Fore.BLUE}{Style.BRIGHT} ]")
